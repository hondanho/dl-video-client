...
const Footer = ({ locale }: { locale: string }) => {
  ...
  return (
    <footer className="body-font bg-gray-100 pb-8 pt-20 text-gray-600">
      <div className="mx-auto flex container flex-col flex-wrap px-4 md:flex-row md:flex-nowrap md:items-center lg:items-start">
        <div className="flex flex-grow flex-wrap text-left md:text-left">
          <div className="privacy px-4 w-1/2 md:w-1/2 lg:w-1/3">
          ...
          <div className="follow-us w-full px-4 md:w-full lg:w-1/3">
            <h2 className="title-font mb-3 font-medium tracking-widest text-gray-900">
              {t("#26")}
            </h2>
            <div>
      ...
      <div className="container mx-auto px-4 mt-10 text-center sm:flex-row">
        <span className="inline-flex justify-center space-x-6 text-center sm:justify-start">
          <Link
            target="_blank"
            title="youtube"
        ...
        <p className="mt-10 px-4 text-center text-sm text-black">
          © 2023{" "}
          <Link
            href="/"
