...
import {
  structuredEntertainmentBusiness,
  structuredFaq,
  structuredHowTo,
...
export default function TiktokPage() {
  let t = useTranslations(`Page.download-tiktok-video`);
  ...
  let FAQ_LIST: FAQ[] = [];
  const faq = useTranslations(`Page.download-tiktok-video.faq`);
  ...
  const structuredFaqJson = structuredFaq(FAQ_LIST);
