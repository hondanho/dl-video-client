    ...
    <main id="main" className="flex w-full flex-1 flex-col">
      ...
      >
        ...
        <div className="mx-auto mt-4 text-xs md:text-sm prose prose-neutral prose-a:no-underline marker:text-xl text-white">
          <p>{t("#1")} <Link href={`/${locale}/privacy-policy`} className="text-[#3BDF70] font-bold">Privacy Policy</Link>.
          </p>
        </div>
      </section>
      ...
      <div className="container mx-auto mb-16 mt-16 flex w-full flex-col gap-24 px-4 text-sm md:px-4 md:text-base">
        ...
        <section className="mx-auto flex max-w-2xl grid-cols-5 flex-wrap items-start justify-center gap-12 md:grid">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <h2 className="whitespace-nowrap pt-3 text-sm">{t("#2")}</h2>
          </div>
          <div className="flex flex-col items-center justify-center text-center">
            <div className="rounded-lg p-2">
            ...
            <h2 className="whitespace-nowrap pt-3 text-sm">{t("#3")}</h2>
          </div>
          <div className="flex flex-col items-center justify-center text-center">
            <div className="rounded-lg p-2">
            ...
            <h2 className="whitespace-nowrap pt-3 text-sm">{t("#4")}</h2>
          </div>
          <div className="flex flex-col items-center justify-center text-center">
            <div className="rounded-lg p-2">
            ...
            <h2 className="whitespace-nowrap pt-3 text-sm">{t("#5")}</h2>
          </div>
          <div className="flex flex-col items-center justify-center text-center">
            <div className="rounded-lg p-2">
        ...
        <section className="grid grid-flow-row text-center gap-12 pb-0 md:pb-0">
          <h2 className="text-2xl font-medium leading-tight tracking-tight sm:text-4xl">{t("#7")}</h2>
          <div className="grid grid-cols-1 items-start justify-items-center md:gap-12 sm:grid-cols-3">
            <div className="grid grid-flow-row justify-items-center gap-2">
              <h3 className="text-xl font-bold leading-tight tracking-tight">1. {t("#8")}</h3>
            ...
            <div className="grid grid-flow-row justify-items-center gap-2">
              <h3 className="text-xl font-bold leading-tight tracking-tight">2. {t("#10")}</h3>
              <div className="max-w-full prose prose-neutral prose-a:no-underline prose-a:text-blue-600 marker:text-xl marker:text-blue-600">
                <p>{t("#11")}</p>
              </div>
              <Image alt={t("#10")}
            ...
            <div className="grid grid-flow-row justify-items-center gap-2">
              <h3 className="text-xl font-bold leading-tight tracking-tight">3. {t("#12")}</h3>
              <div className="max-w-full prose prose-neutral prose-a:no-underline prose-a:text-blue-600 marker:text-xl marker:text-blue-600">
                <p>{t("#13")}</p>
              </div>
              <Image alt={t("#12")}
        ...
        <section className="grid grid-flow-row gap-4 rounded bg-gray-100  p-10">
          <h2 className="text-2xl font-medium leading-tight tracking-tight lg:text-3xl">{t("#14")}</h2>
          <div className="max-w-none md:columns-2 prose prose-neutral prose-a:no-underline prose-a:text-blue-600 marker:text-xl marker:text-blue-600">
            <p>{t("#15")} <Link className="text-primary" href="/">{process.env.NEXT_PUBLIC_WEBSITE_URL}</Link> {t("#16")}  </p>
            <p>{t("#17")}</p>
          </div>
        </section>
        ...
        <section className="grid grid-flow-row gap-12 text-center sm:text-start md:gap-32 ">
          <div className="grid grid-cols-1 gap-8 sm:gap-32 md:grid-cols-2">
            <div className="grid grid-flow-row content-start gap-4">
              <div className="max-w-full prose prose-neutral prose-a:no-underline prose-a:text-blue-600 marker:text-xl marker:text-blue-600">
                <h2 className="text-2xl font-medium leading-tight tracking-tight lg:text-3xl mb-5">{t("#18")}</h2>
                <p>{t("#19")}</p>
              </div>
            </div>
            <Image alt={t("#18")}
          ...
          <div className="grid grid-cols-1 gap-8 sm:gap-32 md:grid-cols-2">
            <div className="grid grid-flow-row content-start gap-4 md:order-last">
              <div className="max-w-full prose prose-neutral prose-a:no-underline prose-a:text-blue-600 marker:text-xl marker:text-blue-600">
                <h2 className="text-2xl font-medium leading-tight tracking-tight lg:text-3xl mb-5">{t("#20")}</h2>
                <p>{t("#21")}</p>
              </div>
            </div>
            <Image alt={t("#20")}
          ...
          <div className="grid grid-cols-1 gap-8 sm:gap-32 md:grid-cols-2">
            <div className="grid grid-flow-row content-start gap-4">
              <div className="max-w-full prose prose-neutral prose-a:no-underline prose-a:text-blue-600 marker:text-xl marker:text-blue-600">
                <h2 className="text-2xl font-medium leading-tight tracking-tight lg:text-3xl mb-5">{t("#22")}</h2>
                <p>{t("#23")}</p>
              </div>
            </div>
            <Image alt={t("#22")}
