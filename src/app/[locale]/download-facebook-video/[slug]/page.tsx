...
const FEATURES_LIST = [
  ...
  },
  {
    ...
    text: "Download Facebook videos in the highest available quality.",
  },
  {
  ...
  },
  {
    ...
    text: "Download as many Facebook videos as you want, with no restrictions.",
  },
  {
...
const BENEFITS_LIST = [
  "Download Facebook videos to back up your content.",
  "Download Facebook videos to preserve your memories",
  "Create your own video compilations using Facebook videos that you download.",
  "Download Facebook videos for research purposes, such as studying a particular trend or social phenomenon.",
  "Save your favorite Facebook videos to your device so you can watch them offline or share them with others.",
  "Use Facebook videos for your own creative projects, such as making Facebook videos or creating presentations.",
  "Download Facebook videos for educational purposes, such as learning about a new skill or watching a historical event.",
];
...
const FAQ_LIST = [
  ...
  },
  {
    ...
    answer: "No, we only provide the service of downloading Facebook videos.",
  },
  {
  ...
  {
    question: "Can I download Facebook videos from private accounts?",
    answer: "No, you cannot download Facebook videos from private accounts.",
  },
  {
    question: "What is the best format to download Facebook videos in?",
    answer:
      "The best format to download Facebook videos in is MP4. MP4 is a widely supported video format that can be played on most devices.",
  },
];
      ...
      <div className="container mx-auto mb-12 mt-8 flex w-full flex-col gap-8 px-4 text-sm md:px-4 md:text-base">
        <section id="welcome">
          <h2 className={cn("mb-4 text-xl font-bold sm:text-3xl")}>
            Welcome to Facebook Video Downloader
          </h2>
          <p className="leading-7">
            Welcome to Facebook Video Downloader! Unlock the world of Facebook
            videos like never before. Our user-friendly platform empowers you to
            effortlessly save your favorite Facebook videos, offering you the
            ...
            collection of Facebook content. Discover the world of Facebook
        ...
        <section id="instructions">
          ...
          <ol className="list-decimal space-y-2 pl-6">
            <li>Go to the Facebook video that you want to download.</li>
          ...
          <div className="mx-auto flex flex-col items-center justify-center px-5 py-10">
            <div className="flex w-full flex-col items-center gap-4 text-center md:w-2/3">
              ...
              <p className="leading-relaxed">
                We now provide an app for Facebook video Download. It is fast,
