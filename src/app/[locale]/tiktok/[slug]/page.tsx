...
import TiktokForm from "@/components/form/TiktokForm";
...
const FEATURES_LIST = [
  ...
  },
  {
    ...
    text: "Download Twitter videos in the highest available quality.",
  },
  {
  ...
  },
  {
    ...
    text: "Download as many Twitter videos as you want, with no restrictions.",
  },
  {
...
const BENEFITS_LIST = [
  "Download Twitter videos to back up your content.",
  "Download Twitter videos to preserve your memories",
  "Create your own video compilations using Twitter videos that you download.",
  "Download Twitter videos for research purposes, such as studying a particular trend or social phenomenon.",
  "Save your favorite Twitter videos to your device so you can watch them offline or share them with others.",
  "Use Twitter videos for your own creative projects, such as making Twitter videos or creating presentations.",
  "Download Twitter videos for educational purposes, such as learning about a new skill or watching a historical event.",
];
...
const FAQ_LIST = [
  ...
  {
    question: "Can I download Twitter stories?",
    answer: "No, downloading Twitter stories is not supported.",
  },
  {
    question: "Can I download images from Tiktok?",
    answer: "No, we only provide the service of downloading Twitter videos.",
  },
  {
  ...
  },
  {
    ...
    answer: "No, you cannot download Twitter videos from private accounts.",
  },
  {
    question: "What is the best format to download Twitter videos in?",
    answer:
      "The best format to download Twitter videos in is MP4. MP4 is a widely supported video format that can be played on most devices.",
  },
];
      ...
      <div className="container mx-auto mb-12 mt-8 flex w-full flex-col gap-8 px-4 text-sm md:px-4 md:text-base">
        <section id="welcome">
          <h2 className={cn("mb-4 text-xl font-bold sm:text-3xl")}>
            Welcome to Twitter Video Downloader
          </h2>
          <p className="leading-7">
            Welcome to Twitter Video Downloader! Unlock the world of Tiktok
            videos like never before. Our user-friendly platform empowers you to
            effortlessly save your favorite Twitter videos, offering you the
            ...
            collection of Twitter content. Discover the world of Tiktok videos
        ...
        <section id="instructions">
          ...
          <ol className="list-decimal space-y-2 pl-6">
            <li>Go to the Twitter video that you want to download.</li>
          ...
          <div className="mx-auto flex flex-col items-center justify-center px-5 py-10">
            <div className="flex w-full flex-col items-center gap-4 text-center md:w-2/3">
              ...
              <p className="leading-relaxed">
                We now provide an app for Twitter video Download. It is fast,
