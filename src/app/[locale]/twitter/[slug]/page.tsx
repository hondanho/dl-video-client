...
const FAQ_LIST = [
  ...
  {
    question: "Can I download images from Twitter ?",
      ...
      <div className="container mx-auto mb-12 mt-8 flex w-full flex-col gap-8 px-4 text-sm md:px-4 md:text-base">
        <section id="welcome">
          ...
          <p className="leading-7">
            Welcome to Twitter Video Downloader! Unlock the world of Twitter
            ...
            collection of Twitter content. Discover the world of Twitter videos
